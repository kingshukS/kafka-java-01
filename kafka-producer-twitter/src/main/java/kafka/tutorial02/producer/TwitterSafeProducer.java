...
public class TwitterSafeProducer {
    ...
    private final List<String> terms = Lists.newArrayList("IPL");
    private static Logger logger = LoggerFactory.getLogger(TwitterSafeProducer.class);
    ...
    public KafkaProducer<String, String> createKafkaProducer() {
        ...
        properties.setProperty(ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION,"5");// for kafka 2.8>=1.1 5, else 1
